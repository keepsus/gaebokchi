 ...
 * Generated at: 2021-02-15 02:15:25 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write(" \t\t\t//$('#goodsIndexList').html(\"<div style='color:red; font-weight:bold'>css 먹히나여?</div>\");\r\n");
      out.write("\t\t\t//alert(JSON.stringify(data)); \r\n");
      out.write(" \t\t\t//console.log(data);\t\t\t\r\n");
      out.write(" \t\t\t$.each(data.list, function(index, items){\r\n");
      out.write(" \t\t\t\t$('<div class=\"item-wrapper\"/>').append($('<div class=\"imgTransform\">',{\r\n");
      out.write(" \t \t\t\t\t}).append($('<img/>',{\r\n");
      out.write("\t \t\t\t\t\tsrc: '/slime/storage/'+items.goods_image0,\r\n");
      out.write("\t \t\t\t\t\tstyle: 'width: 400px; cursor: pointer;',\r\n");
      ...
      out.write(" \t\t\t\t\talign: 'center',\r\n");
      out.write("\t\t\t\t\ttext: \"정상가 : \"+items.goods_sales_price\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write(" \t\t\t\t})).append($('<br>')).append($('<span/>',{\r\n");
      out.write(" \t \t\t\t\talign: 'center',\r\n");
      out.write(" \t\t\t\t\ttext: \"세일가 : \"+items.goods_price\r\n");
      out.write(" \t\t\t\t\t\t\r\n");
